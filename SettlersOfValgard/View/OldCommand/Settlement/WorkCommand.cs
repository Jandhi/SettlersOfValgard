...
{
    public class WorkCommand : OldCommand.Command
    {
        ...
        private void EmployWorkers(Model.Settlement.Settlement settlement, string name, int ordinal)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    foreach (var building in targetBuildings)
                    {
                        ...
                        if (workersToEmploy > 0) workplacesEmployedCount++;
                    ...
                    var buildingPlural = workplacesEmployedCount > 1 ? "s" : "";
                    CustomConsole.WriteLine($"{CustomConsole.Green}Employed {employedCount} workers at {workplacesEmployedCount} {name}{buildingPlural}!");
                }
            }
        }
    }
